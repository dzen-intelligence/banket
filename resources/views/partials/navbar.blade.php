    ...
    <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
        <div class="container-fluid">
            <div class="d-flex align-items-center"><a href="{{ route('home') }}" class="navbar-brand py-1"><img
                            src={{ url()->asset('/template/img/logo.svg')  }} height="31px;" alt="Directory logo"></a>
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @auth
                    <li class="nav-item"><a href="{{ url('/') }}" class="nav-link">Личный кабинет</a></li>
                    <li class="nav-item"><a href="{{ route('logout') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"  class="nav-link">Выйти</a></li>
                    ...
                    @endauth
                    <li class="nav-item mt-3 mt-lg-0 ml-lg-3 d-lg-none d-xl-inline-block"><a href="user-add-0.php"
