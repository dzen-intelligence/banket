        ...
        <div class="container">
            ...
            <form method="post" action="{{ route('accommodate.post_step3') }}" enctype="multipart/form-data" class="dropzone1" id="my-dropzone">
                ...
                <div class="row form-block">
                    ...
                    <div class="col-lg-7 ml-auto">
                        ...
                        <div class="form-group">
                            ...
                            <input name="person_price" id="form_name" class="form-control">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <textarea name="hall_description" id="form_description" rows="5"
                ...
                <div class="row form-block flex-column flex-sm-row">
                    ...
                    px-3">Далее<i class="fa-chevron-right fa ml-2"></i></button>
                    </div>
                </div>
            </form>
        </div>
